...
#ifndef mozilla_net_BaseWebSocketPPChannel_h
#define mozilla_net_BaseWebSocketPPChannel_h
...
class BaseWebSocketPPChannel : public nsIWebSocketChannel,
                             public nsIProtocolHandler
{
 public:
  ...
  // Partial implementation of nsIWebSocketPPChannel
  //
...
#endif // mozilla_net_BaseWebSocketPPChannel_h
