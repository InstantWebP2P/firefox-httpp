...
#ifndef mozilla_net_WebSocketPPChannel_h
#define mozilla_net_WebSocketPPChannel_h
...
// {1f443279-d03c-4810-96b7-660ed6693468}
#define IWEBPP_WSPPHANDLER_CID     \
{ 0x1f443279, 0xd03c, 0x4810, \
    { 0x66, 0x0e, 0xd6, 0x69, 0x34, 0x68} }
...
class WebSocketPPChannel : public BaseWebSocketPPChannel,
...
public:
  ...
  // nsIWebSocketPPChannel methods BaseWebSocketPPChannel didn't implement for us
  //
...
class WebSocketPPSSLChannel : public WebSocketPPChannel
{
public:
    WebSocketPPSSLChannel() { BaseWebSocketPPChannel::mEncrypted = true; }

    // Define a Create method to be used with a factory:
    static nsresult Create(nsISupports *aOuter, REFNSIID aIID, void **aResult);

protected:
    virtual ~WebSocketPPSSLChannel() {}
};

#endif // mozilla_net_WebSocketPPChannel_h
